...
function getMatchTypeNameByMatchTypeId($matchTypeId) {
...
function getFactionShortNameByFactionId($factionId) {
	static $factions = array();
...
function getShowNameByShowId($showId) {
	static $shows = array();
...
function getShowShortNameByShowId($showId) {
	static $shows = array();
...
function getSuperstarNameBySuperstarId($superstarId) {
...
function getSuperstarShortNameBySuperstarId($superstarId) {
	static $superstars = array();
